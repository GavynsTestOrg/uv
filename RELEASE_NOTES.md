...
* Reduced duplicate entries in generated software bill of materials output so dependency records stay cleaner and easier to review.
* Simplified Windows Intel XPU detection so hardware checks keep working with lower system overhead through native Windows APIs.