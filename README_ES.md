...
- Incluye una [interfaz compatible con pip](#the-pip-interface) para mejorar el rendimiento con una
  CLI familiar.
...
Cree un nuevo script y añada metadatos en línea que declaren sus dependencias:
...
por cualquier persona, tal como se define en la licencia Apache-2.0, tendrá doble licencia como se indicó antes, sin
