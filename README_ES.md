...
- Incluye una [interfaz compatible con pip](#the-pip-interface) para un aumento de rendimiento con una
  CLI conocida.
...
uv administra las dependencias y los entornos del proyecto, con compatibilidad para archivos de bloqueo, workspaces y más,
...
uv también admite compilar y publicar proyectos, incluso si no se administran con uv. Consulte la
...
Ejecute una herramienta en un entorno efímero usando `uvx` (un alias de `uv tool run`):
...
a las personas que mantienen PubGrub, en especial a [Jacob Finkelman](https://github.com/Eh2406), por
su apoyo.

La implementación de Git de uv se basa en [Cargo](https://github.com/rust-lang/cargo).

Algunas de las optimizaciones de uv se inspiran en el gran trabajo que se ha visto en [pnpm](https://pnpm.io/),
...
uv se distribuye bajo cualquiera de las siguientes licencias:
