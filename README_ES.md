...
- Incluye una [interfaz compatible con pip](#the-pip-interface) para una mejora del rendimiento con una
  CLI conocida.
- Soporta [workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces) al estilo de Cargo para
...
uv también soporta la compilación y publicación de proyectos, incluso si no se gestionan con uv. Consulta la
...
Consulta la [documentación de la interfaz de pip](https://docs.astral.sh/uv/pip/index/) para comenzar.

## Contribuir

Existe un gran interés por apoyar a colaboradores con todos los niveles de experiencia y sería excelente ver más
...
Sí, uv es estable y se usa ampliamente en producción. Consulta el documento sobre la
[política de versiones](https://docs.astral.sh/uv/reference/versioning/) de uv para obtener detalles.

## Agradecimientos

El resolvedor de dependencias de uv usa [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. Existe un gran aprecio por los mantenedores de PubGrub, en especial por [Jacob Finkelman](https://github.com/Eh2406), por su apoyo.
