...
- Una sola herramienta para sustituir `pip`, `pip-tools`, `pipx`, `poetry`, `pyenv`, `twine`, `virtualenv`, y
  más.
...
uv gestiona las dependencias y los entornos del proyecto, con soporte para archivos de bloqueo, workspaces y más,
...
Migre a uv sin cambiar sus flujos de trabajo existentes y experimente una aceleración de 10-100x con la
interfaz `uv pip`.
...
Nos apasiona apoyar a colaboradores de todos los niveles de experiencia y nos encantaría ver su participación en el
...
El resolvedor de dependencias de uv usa [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. Agradecemos
a los mantenedores de PubGrub, en especial a [Jacob Finkelman](https://github.com/Eh2406), por su apoyo.

La implementación de Git de uv se basa en [Cargo](https://github.com/rust-lang/cargo).

Algunas de las optimizaciones de uv se inspiran en el gran trabajo que hemos visto en [pnpm](https://pnpm.io/),
[Orogene](https://github.com/orogene/orogene) y [Bun](https://github.com/oven-sh/bun). También hemos aprendido
mucho de [Posy](https://github.com/njsmith/posy) de Nathaniel J. Smith y adaptado su
...
Salvo que se indique explícitamente lo contrario, cualquier contribución enviada intencionadamente para su inclusión en uv
por parte del colaborador, tal como se define en la licencia Apache-2.0, tendrá doble licencia como se indicó arriba, sin
