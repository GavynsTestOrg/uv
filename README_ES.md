...
<p align="center">
  <picture align="center">
    ...
    <img alt="Muestra un gráfico de barras con resultados comparativos." src="https://github.com/astral-sh/uv/assets/1309177/629e59c0-9c6e-4013-9ad4-adb2bcf5080d">
  </picture>
</p>
...
- Una sola herramienta para reemplazar `pip`, `pip-tools`, `pipx`, `poetry`, `pyenv`, `twine`, `virtualenv` y muchas más.
...
- Incluye una [interfaz compatible con pip](#la-interfaz-pip) para obtener una mejora de rendimiento con una CLI conocida.
- Admite [workspaces](https://docs.astral.sh/uv/concepts/projects/workspaces) al estilo de Cargo para proyectos escalables.
- Aprovecha el espacio en disco de forma eficiente, con una [caché global](https://docs.astral.sh/uv/concepts/cache) para deduplicar dependencias.
...
Consulte la [documentación de instalación](https://docs.astral.sh/uv/getting-started/installation/) para ver los detalles y otros métodos de instalación.
...
uv gestiona dependencias y entornos de proyecto, con soporte para archivos de bloqueo, workspaces y más, de forma similar a `rye` o `poetry`:
...
uv también admite compilar y publicar proyectos, incluso si uv no los gestiona. Consulte la [guía de publicación](https://docs.astral.sh/uv/guides/publish/) para obtener más información.
...
Compile requisitos en un archivo `requirements` independiente de la plataforma:
...
Existe un gran interés en apoyar a personas colaboradoras con cualquier nivel de experiencia y en verlas participar en el proyecto. Consulte la [guía de contribución](https://github.com/astral-sh/uv?tab=contributing-ov-file#contributing) para comenzar.
...
Simplemente "uv", por favor. Consulte la [guía de estilo](./STYLE.md#styling-uv) para ver los detalles.
...
Salvo que se indique explícitamente lo contrario, cualquier contribución enviada intencionadamente para su inclusión en uv, tal como se define en la licencia Apache-2.0, tendrá doble licencia como se indicó antes, sin términos ni condiciones adicionales.
