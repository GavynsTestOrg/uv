...
<p align="center">
  <i>Instalando las dependencias de <a href="https://trio.readthedocs.io/">Trio</a> con una caché precargada.</i>
</p>
...
uv gestiona dependencias y entornos de proyecto, con soporte para lockfiles, workspaces y más,
...
uv también admite compilar y publicar proyectos, incluso si uv no los gestiona. Consulte la
...
Migre a uv sin cambiar los flujos de trabajo existentes y obtenga un aumento de velocidad de 10-100x con la
interfaz `uv pip`.
...
Instale los requisitos fijados:
...
según se define en la licencia Apache-2.0, quedará sujeta a doble licencia como se indicó antes, sin
