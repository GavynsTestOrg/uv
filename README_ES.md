...
Consulta la [documentación de instalación](https://docs.astral.sh/uv/getting-started/installation/) para obtener más detalles y métodos de instalación alternativos.
...
uv también soporta la compilación y publicación de proyectos, incluso si no se administran con uv. Consulta la [guía de publicación](https://docs.astral.sh/uv/guides/publish/) para obtener más información.
...
Migra a uv sin cambiar tus flujos de trabajo existentes y experimenta una aceleración de 10-100x con la interfaz `uv pip`.

Compila los requirements en un archivo de requirements independiente de la plataforma:
...
Instala los requirements bloqueados:
...
Nos apasiona apoyar a quienes contribuyen con todos los niveles de experiencia y nos encantaría ver participación en el proyecto. Consulta la [guía de contribución](https://github.com/astral-sh/uv?tab=contributing-ov-file#contributing) para comenzar.
...
Salvo que se indique explícitamente lo contrario, cualquier contribución enviada intencionalmente para su inclusión en uv, según se define en la licencia Apache-2.0, tendrá doble licencia como se indica arriba, sin términos ni condiciones adicionales.
