...
- Una sola herramienta para reemplazar `pip`, `pip-tools`, `pipx`, `poetry`, `pyenv`, `twine`, `virtualenv` y
  más.
- [10-100x faster](https://github.com/astral-sh/uv/blob/main/BENCHMARKS.md) que `pip`.
...
O desde [PyPI](https://pypi.org/project/uv/):
...
uv gestiona dependencias y entornos de proyectos, con compatibilidad para archivos de bloqueo, workspaces y más,
...
uv también admite la compilación y publicación de proyectos, incluso si no se gestionan con uv. Consulta la
...
uv amplía sus interfaces con funciones avanzadas, como reemplazos de versión de dependencias,
resoluciones independientes de la plataforma, resoluciones reproducibles, estrategias de resolución alternativas y
más.

Migra a uv sin cambiar tus flujos de trabajo actuales y experimenta una aceleración de 10-100x con la
interfaz `uv pip`.
...
Existe un fuerte compromiso con apoyar a personas colaboradoras de todos los niveles de experiencia y sería excelente contar con más participación en el proyecto. Consulta la
...
El resolvedor de dependencias de uv usa [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. Agradecemos a las personas mantenedoras de PubGrub, en especial a [Jacob Finkelman](https://github.com/Eh2406), por su apoyo.

La implementación de Git de uv se basa en [Cargo](https://github.com/rust-lang/cargo).

Algunas de las optimizaciones de uv están inspiradas en el gran trabajo presente en [pnpm](https://pnpm.io/),
...
uv cuenta con licencia bajo una de las siguientes opciones:
...
A menos que se indique explícitamente lo contrario, cualquier contribución enviada intencionalmente para incluirse en uv
por parte de la persona colaboradora, según la definición de la licencia Apache-2.0, tendrá doble licencia como se indicó antes, sin
ningún término o condición adicional.
