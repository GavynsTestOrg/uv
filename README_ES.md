...
- [Ejecuta scripts](#scripts), con compatibilidad para [metadatos de dependencias en línea](https://docs.astral.sh/uv/guides/scripts#declaring-script-dependencies).
...
uv administra dependencias y entornos de proyectos, con compatibilidad para archivos de bloqueo, workspaces y más, de forma similar a `rye` o `poetry`:
...
uv también permite compilar y publicar proyectos, incluso si no los administra uv. Consulte la [guía de publicación](https://docs.astral.sh/uv/guides/publish/) para obtener más información.
...
Consulte la [documentación sobre scripts](https://docs.astral.sh/uv/guides/scripts/) para comenzar.
...
Migre a uv sin cambiar los flujos de trabajo existentes y obtenga una aceleración de 10-100x con la interfaz `uv pip`.
...
Se pronuncia "you - vee" ([`/juː viː/`](https://en.wikipedia.org/wiki/Help:IPA/English#Key))

#### ¿Cómo debe escribirse uv?

Simplemente "uv". Consulte la [guía de estilo](./STYLE.md#styling-uv) para obtener más detalles.
...
Sí, uv es estable y se utiliza ampliamente en producción. Consulte el documento de [política de versionado](https://docs.astral.sh/uv/reference/versioning/) de uv para obtener más detalles.
...
Salvo que se indique explícitamente lo contrario, cualquier contribución enviada intencionalmente para su inclusión en uv, según la definición de la licencia Apache-2.0, tendrá doble licencia como se indicó anteriormente, sin términos ni condiciones adicionales.
