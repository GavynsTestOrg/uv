...
ver detalles y métodos de instalación alternativos.
...
Existe una gran dedicación para apoyar a colaboradores de todos los niveles de experiencia y sería excelente
contar con su participación en el proyecto. Consulte la
...
uv se pronuncia "you - vee" ([`/juː viː/`](https://en.wikipedia.org/wiki/Help:IPA/English#Key))

#### ¿Cómo debe estilizarse uv?
...
El resolvedor de dependencias de uv usa [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. uv agradece el
apoyo de los mantenedores de PubGrub, en especial de [Jacob Finkelman](https://github.com/Eh2406).
...
del [Posy](https://github.com/njsmith/posy) de Nathaniel J. Smith y adaptó su
...
según se define en la licencia Apache-2.0, tendrá doble licencia como se indica arriba, sin
