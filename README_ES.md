...
- Ofrece una [gestión integral de proyectos](#projects), con un
...
- Incluye una [interfaz compatible con pip](#the-pip-interface) para obtener más rendimiento con una
  CLI familiar.
...
- Usa el espacio en disco de forma eficiente, con una [caché global](https://docs.astral.sh/uv/concepts/cache) para
  eliminar duplicados entre dependencias.
- Admite instalación sin Rust ni Python mediante `curl` o `pip`.
...
uv gestiona las dependencias y los entornos de los proyectos, con soporte para archivos de bloqueo, workspaces y más,
...
uv también admite la compilación y publicación de proyectos, incluso si no se gestionan con uv. Consulte la
...
Migre a uv sin cambiar los flujos de trabajo existentes y obtenga una aceleración de 10-100x con la
interfaz `uv pip`.
...
Existe un fuerte compromiso con apoyar a contribuyentes de todos los niveles de experiencia y sería excelente contar con más participación
en el proyecto. Consulte la
...
El resolvedor de dependencias de uv usa [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. Los mantenedores de PubGrub, en especial [Jacob Finkelman](https://github.com/Eh2406), brindan un apoyo muy valorado.
...
[Orogene](https://github.com/orogene/orogene) y [Bun](https://github.com/oven-sh/bun). También se aprendió mucho del [Posy](https://github.com/njsmith/posy) de Nathaniel J. Smith y se adaptó su
...
por una persona, según la definición de la licencia Apache-2.0, tendrá doble licencia como se indicó arriba, sin
