...
<p align="center">
  <picture align="center">
    ...
    <img alt="Muestra un gráfico de barras con resultados de benchmarks." src="https://github.com/astral-sh/uv/assets/1309177/629e59c0-9c6e-4013-9ad4-adb2bcf5080d">
  </picture>
</p>
...
Consulta la [documentación de instalación](https://docs.astral.sh/uv/getting-started/installation/) para ver
...
uv también admite compilar y publicar proyectos, incluso si no están gestionados con uv. Consulta la
...
Crea un nuevo script y agrega metadatos en línea que declaren sus dependencias:
...
uv amplía sus interfaces con características avanzadas, como sobrescrituras de versiones de dependencias,
...
Compila requirements en un archivo de requirements independiente de la plataforma:
...
[política de versionado](https://docs.astral.sh/uv/reference/versioning/) de uv para ver más detalles.

## Agradecimientos

El resolvedor de dependencias de uv usa [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. Agradecemos
a los mantenedores de PubGrub, especialmente a [Jacob Finkelman](https://github.com/Eh2406), por
su apoyo.

La implementación de Git de uv se basa en [Cargo](https://github.com/rust-lang/cargo).

Algunas de las optimizaciones de uv están inspiradas en el gran trabajo que hemos visto en [pnpm](https://pnpm.io/),
[Orogene](https://github.com/orogene/orogene) y [Bun](https://github.com/oven-sh/bun). También hemos
aprendido mucho de [Posy](https://github.com/njsmith/posy) de Nathaniel J. Smith y hemos adaptado su
