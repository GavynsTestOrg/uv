...
Si se instala con el instalador independiente, uv puede actualizarse a la versión más reciente:
...
uv también admite la compilación y publicación de proyectos, incluso si uv no los gestiona. Consulte la
...
Cree un script nuevo y añada metadatos en línea que declaren sus dependencias:
...
uv ofrece un reemplazo directo para los comandos comunes de `pip`, `pip-tools` y `virtualenv`.
...
Compile requirements en un archivo de requirements independiente de la plataforma:
...
Instale los requirements bloqueados:
...
Existe un gran interés en apoyar a colaboradores de todos los niveles de experiencia y sería excelente contar con más participación en el proyecto. Consulte la
...
El resolutor de dependencias de uv utiliza [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. Existe un agradecimiento a los mantenedores de PubGrub, en especial a [Jacob Finkelman](https://github.com/Eh2406), por su apoyo.
...
uv se distribuye bajo cualquiera de estas licencias:
...
A menos que se indique expresamente lo contrario, toda contribución enviada intencionalmente para incluirse en uv,
según la definición de la licencia Apache-2.0, tendrá doble licencia como se indicó antes, sin
