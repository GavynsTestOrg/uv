...
uv gestiona las dependencias y los entornos de los proyectos, con compatibilidad para archivos de bloqueo, workspaces y más,
...
Consulte la [documentación de proyectos](https://docs.astral.sh/uv/guides/projects/) para empezar.

uv también admite la compilación y publicación de proyectos, incluso si no están gestionados con uv. Consulte la
...
Consulte la [documentación de scripts](https://docs.astral.sh/uv/guides/scripts/) para empezar.
...
Consulte la [documentación de herramientas](https://docs.astral.sh/uv/guides/tools/) para empezar.
...
Consulte la [documentación de la interfaz pip](https://docs.astral.sh/uv/pip/index/) para empezar.

## Contribuir

Existe una gran pasión por apoyar a contribuyentes de todos los niveles de experiencia y será un placer contar con más participación en el proyecto. Consulte la
...
El resolvedor de dependencias de uv usa [PubGrub](https://github.com/pubgrub-rs/pubgrub) internamente. uv agradece a los mantenedores de PubGrub, en especial a [Jacob Finkelman](https://github.com/Eh2406), por
su apoyo.
...
por su autor, según la definición de la licencia Apache-2.0, tendrá doble licencia como se indicó arriba, sin
