...
Migra a uv sin cambiar flujos de trabajo existentes y experimenta una aceleración de 10-100x con la
interfaz `uv pip`.
...
por una persona, tal como se define en la licencia Apache-2.0, tendrá doble licencia como se indica arriba, sin
